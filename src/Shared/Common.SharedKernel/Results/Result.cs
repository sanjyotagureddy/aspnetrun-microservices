...
public class Result
{
    ...
    public static Result Failure(string error) => new(false, Guard.Against.NullOrWhiteSpace(error));
}
...
public sealed class Result<T> : Result
{
    ...
    public new static Result<T> Failure(string error) => new(false, default, Guard.Against.NullOrWhiteSpace(error));
}