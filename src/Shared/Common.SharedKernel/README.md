...
- `Messaging/` for event and messaging contracts.
...
The initial implementation currently includes shared exceptions, a message base contract, logging contracts, and correlation primitives; the remaining folders are reserved for future primitives.
