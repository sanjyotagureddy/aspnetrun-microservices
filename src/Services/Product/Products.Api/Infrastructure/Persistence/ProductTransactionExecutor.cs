...
internal interface IProductTransactionExecutor
{
...
internal sealed class ProductTransactionExecutor(NpgsqlDataSource dataSource) : IProductTransactionExecutor
{
