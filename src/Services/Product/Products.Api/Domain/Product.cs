...
internal sealed class Product : AuditableEntity<Guid>
{
        ...
        bool isActive)
    {
        ...
        Sku = Guard.Against.NullOrWhiteSpace(sku, nameof(sku)).Trim().ToUpperInvariant();
        Currency = Guard.Against.NullOrWhiteSpace(currency, nameof(currency)).Trim().ToUpperInvariant();
        Category = Guard.Against.NullOrWhiteSpace(category, nameof(category)).Trim();
        Brand = Guard.Against.NullOrWhiteSpace(brand, nameof(brand)).Trim();
        Price = price;
